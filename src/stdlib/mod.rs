...
pub fn builtin_global(name: &str) -> Option<Value> {
    Some(match name {
        ...
        "MmioRead32" => Value::Native(MMIO_READ32),
        "MmioWrite32" => Value::Native(MMIO_WRITE32),
        "Spin" => Value::Native(SPIN),
        "IsFreestanding" => Value::Native(IS_FREESTANDING),
        ...
        "Web" => Value::TypeModule("Web".into()),
        "Template" => Value::TypeModule("Template".into()),
        "Sqlite" => Value::TypeModule("Sqlite".into()),
    ...
    match obj {
        ...
        Value::Object(o) => {
            ...
            match o.class_name.as_str() {
                ...
                "SqliteConnection" => match name {
                    "Execute" => Ok(Value::Native(SQLITE_EXECUTE)),
                    "Query" => Ok(Value::Native(SQLITE_QUERY)),
                    "QueryOne" => Ok(Value::Native(SQLITE_QUERY_ONE)),
                    "LastInsertRowId" => Ok(Value::Native(SQLITE_LAST_INSERT_ROWID)),
                    "Close" => Ok(Value::Native(SQLITE_CLOSE)),
                    _ => Err(undef(&o.class_name, name)),
                },
                "Mutex" => match name {
...
fn static_member(module: &str, name: &str) -> RuntimeResult<Value> {
    let id = match (module, name) {
        ...
        ("HttpServer", "ServeScript") => HTTP_SERVER_SERVE_SCRIPT,
        ...
        ("Web", "Method") => WEB_METHOD,
        ("Web", "Path") => WEB_PATH,
        ("Web", "Query") => WEB_QUERY,
        ("Web", "Form") => WEB_FORM,
        ("Web", "Header") => WEB_HEADER,
        ("Web", "Cookie") => WEB_COOKIE,
        ("Web", "Body") => WEB_BODY,
        ("Web", "SetStatus") => WEB_SET_STATUS,
        ("Web", "SetHeader") => WEB_SET_HEADER,
        ("Web", "SetCookie") => WEB_SET_COOKIE,
        ("Web", "Write") => WEB_WRITE,
        ("Web", "Text") => WEB_TEXT,
        ("Web", "Html") => WEB_HTML,
        ("Web", "Json") => WEB_JSON,
        ("Web", "Redirect") => WEB_REDIRECT,
        ("Web", "Render") => WEB_RENDER,
        ("Web", "File") => WEB_FILE,
        ("Web", "IsHtmx") => WEB_IS_HTMX,
        ("Web", "ScriptDir") => WEB_SCRIPT_DIR,
        ("Web", "StaticDir") => WEB_STATIC_DIR,
        ("Web", "ParseJson") => WEB_PARSE_JSON,
        ("Template", "Render") => TEMPLATE_RENDER,
        ("Sqlite", "Open") => SQLITE_OPEN,
...
pub fn call_native(id: usize, args: &[Value]) -> RuntimeResult<Value> {
    match id {
        ...
        MMIO_READ32 => Ok(Value::Int(0)),
        MMIO_WRITE32 => Ok(Value::Null),
        SPIN => Ok(Value::Null),
        IS_FREESTANDING => Ok(Value::Bool(false)),
        ...
        HTTP_SERVER_SERVE_SCRIPT => crate::web_runtime::http_server_serve_script(args),
        ...
        SQLITE_OPEN => crate::web_runtime::sqlite_open(args),
        SQLITE_EXECUTE => crate::web_runtime::sqlite_execute(args),
        SQLITE_QUERY => crate::web_runtime::sqlite_query(args),
        SQLITE_QUERY_ONE => crate::web_runtime::sqlite_query_one(args),
        SQLITE_LAST_INSERT_ROWID => crate::web_runtime::sqlite_last_insert_rowid(args),
        SQLITE_CLOSE => crate::web_runtime::sqlite_close(args),
        WEB_METHOD => crate::web_runtime::web_method(args),
        WEB_PATH => crate::web_runtime::web_path(args),
        WEB_QUERY => crate::web_runtime::web_query(args),
        WEB_FORM => crate::web_runtime::web_form(args),
        WEB_HEADER => crate::web_runtime::web_header(args),
        WEB_COOKIE => crate::web_runtime::web_cookie(args),
        WEB_BODY => crate::web_runtime::web_body(args),
        WEB_SET_STATUS => crate::web_runtime::web_set_status(args),
        WEB_SET_HEADER => crate::web_runtime::web_set_header(args),
        WEB_SET_COOKIE => crate::web_runtime::web_set_cookie(args),
        WEB_WRITE => crate::web_runtime::web_write(args),
        WEB_TEXT => crate::web_runtime::web_text(args),
        WEB_HTML => crate::web_runtime::web_html(args),
        WEB_JSON => crate::web_runtime::web_json(args),
        WEB_REDIRECT => crate::web_runtime::web_redirect(args),
        WEB_RENDER => crate::web_runtime::web_render(args),
        WEB_FILE => crate::web_runtime::web_file(args),
        TEMPLATE_RENDER => crate::web_runtime::template_render(args),
        WEB_IS_HTMX => crate::web_runtime::web_is_htmx(args),
        WEB_SCRIPT_DIR => crate::web_runtime::web_script_dir(args),
        WEB_STATIC_DIR => crate::web_runtime::web_static_dir(args),
        WEB_PARSE_JSON => crate::web_runtime::web_parse_json(args),
